...
def adls_bulk_upload(
    ...
    Args:
        ...
        file_names_relative_path (str, optional): Path where to save the file locally. Defaults to ''.
    ...
    for file in file_names:
        ...
        file_to_adls_task.run(
            from_path=os.path.join(file_names_relative_path, file),
            to_path=file_path,
...
class MindfulToADLS(Flow):
    ...
    def mind_flow(self) -> Flow:
        ...
        uploader = adls_bulk_upload(
            ...
            file_names_relative_path=self.file_path,
