...
def test_get_promoted_adls_path_file():
    ...
    if adls_path_file.split(".")[-1] == "parquet":
        assert "conformed/supermetrics/adls_ga_load_times_fr_test.csv"
    else:
        assert "conformed/supermetrics/adls_ga_load_times_fr_test/2021-07-14T13%3A09%3A02.997357%2B00%3A00.csv"
