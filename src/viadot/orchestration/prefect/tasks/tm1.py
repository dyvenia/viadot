...
from src.viadot.config import get_source_credentials
from src.viadot.orchestration.prefect import tasks
from src.viadot.orchestration.prefect.exceptions import MissingSourceCredentialsError
from src.viadot.orchestration.prefect.utils import get_credentials
from src.viadot.sources.tm1 import TM1


@tasks(retries=3, retry_delay_seconds=10, timeout_seconds=60 * 60 * 3)
def tm1_to_df(
    ...
    limit: int | None = None,
    private: bool = False,
    credentials_secret: dict[str, Any] | None = None,
    config_key: str = "TM1",
    verify: bool = False,
    if_empty: str = "skip",
) -> DataFrame:
