...
@flow(
    ...
    description="Extract data from OneStram SQL queries and load it to Redshift Spectrum.",
    retries=1,
...
def onestream_sql_query_data_to_redshift_spectrum(  # noqa: PLR0913
    ...
    This flow executes a SQL query in OneStream using provided parameters of the
