...
#include "inc/SapRfcConnector.h"
#include "inc/SapFunctionCaller.h"
#include "inc/SqlParser.h"
#include "inc/SapErrorHandler.h"
#include "inc/utils.h"
...
PYBIND11_MODULE(sap_rfc_connector, m) {
    ...
    py::class_<SapFunctionCaller>(m, "SapFunctionCaller")
        ...
        .def("get_function_description", &SapFunctionCaller::get_function_description, py::arg("function_name"), "Get function metadata from SAP")
        .def("call", &SapFunctionCaller::call, py::arg("func"), py::arg("params"), py::arg("tables"), "Call a function with parameters and return results as a map")
        .def("get_table_metadata", &SapFunctionCaller::get_table_metadata, py::arg("table_name"), "Get table metadata from SAP")
        .def("rfc_read_table_query", &SapFunctionCaller::rfc_read_table_query,
            py::arg("sql"),
            py::arg("sep") = "",
            py::arg("rowskips") = 0,
            py::arg("rowcount") = 0,
            "RFC_READ_TABLE query")
        .def("query", &SapFunctionCaller::query,
            py::arg("sql"),
            py::arg("sep") = "",
            "Equivalent to Python SAPRFC.query()");
} 