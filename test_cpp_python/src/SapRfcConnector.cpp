...
SapRfcConnector::~SapRfcConnector() {
    close_connection();
}

bool SapRfcConnector::connect(const std::string& user, const std::string& passwd, const std::string& ashost, const std::string& sysnr) {
    ...
    // Assume to_u16string is available as a utility function
...
RFC_CONNECTION_HANDLE SapRfcConnector::con() const {
    return connection;
}
